# Update state for ruleoflawfail.com

This file tracks how current the site's content is. The `/update-tracker` skill reads it to set the research window for the next update.

- **Content current through:** September 19, 2026
- **Trump Tyranny Tracker substack:** reviewed as lead source through Day 599 (September 14, 2026)
- **Last update method:** parallel research agents (window August 18 – September 19, 2026); sources: Trump Tyranny Tracker substack (Days 569–599, lead-finder only), Just Security litigation tracker, Lawfare tracker (blocked), GAO impoundment page, Revolving Door Project tracker, CREW, Campaign Legal Center, Democracy Docket, Brookings K-12 tracker, Stanford Immigration Policy Tracking Project, and targeted searches of AP/Reuters/NYT/WaPo/NPR/CNN/CNBC/Politico/Bloomberg/SCOTUSblog and court documents

## Source-status notes
- **Revolving Door Project court non-adherence tracker** is still stale — confirmed September 19, 2026 that the tracker content still ends November 4, 2025. Keep relying on targeted searches for court-defiance findings.
- **Lawfare litigation tracker** again returned no fetchable content to automated requests.
- **Just Security litigation tracker** fetched but again carried no entries specific to this window.
...
- Fifth Circuit en banc on the ICE no-bond detention policy — argument calendared September 23–25, 2026
- Fourth Circuit appeal of the Comey/James dismissals — argued September 15, 2026, decision pending; the Comey "86 47" prosecution remains pending on a motion to dismiss
- Supreme Court cert petition on acting U.S. attorney appointments under the FVRA (filed September 9, 2026)
...
- FBI headquarters ruling — appeal noticed August 2026
- Hatch Act complaints (Hegseth, Miller, RFK Jr.) still pending at OSC with no findings
- Treasury/IRS plan to strip tax-exempt status from disfavored nonprofits — Senate Finance inquiry opened September 2, 2026; watch for confirmation by a wire service
- 2030 census apportionment proposal (announced September 9, 2026) — watch for a final rule and litigation

## Borderline items considered and deliberately NOT added
Per the user's standing instruction, borderline items stay off the site and are revisited only if they firm up.
- 2030 census proposal to exclude non-green-card immigrants from apportionment (September 9, 2026) — proposed, not final, not litigated
- FCC pressure leading Jimmy Kimmel to move a Senate candidate's interview off broadcast (September 10, 2026) — disputed facts, no litigation; the related Disney/ABC suit WAS added
- Treasury/IRS nonprofit tax-status "blueprint" (reported August 27, 2026) — originating report is the New York Post, unconfirmed by a wire service
- Second Hegseth Hatch Act complaint over an Iowa State Fair fundraiser — complaint only, no OSC finding
- DOJ criminal probe of Gov. Newsom's travel-funding nonprofit (September 2026) — investigation ongoing, motive disputed
- Trump's oil and gas stock trades during the Iran war (September 9, 2026) — ethics-expert concern, no statute identified
- Steve Witkoff's $257 million income disclosure including a crypto stake (September 2026) — disclosed and lawful on its face
- RFK Jr.'s use of military aircraft for midterm campaign travel (September 10, 2026) — no OSC finding
- Trump Tower Tbilisi land deal tied to a sanctioned oligarch's family (September 2026) — WSJ-sourced, no legal claim asserted
- DHS use of PATRIOT Act §314(a) financial-surveillance authority against unions and climate groups (reported September 8, 2026) — sourcing did not meet the standard; strong candidate if a major outlet picks it up
- DOJ filing against New Jersey's ICE mask-ban law (September 16, 2026) — no ruling yet
- Education Department accreditation overhaul NPRM (August 20, 2026) — proposed rule only

## Excluded as not administration actions
- Missouri's GOP-favoring congressional map, blocked by Justice Kavanaugh (September 8, 2026) — state legislative action
- Senate failure of the CLARITY Act crypto bill over Trump-family conflicts (September 15, 2026) — congressional, not an administration action
- Judge Payne blocking Virginia's law limiting police-ICE cooperation (September 2, 2026) — the court ruled *for* the administration
